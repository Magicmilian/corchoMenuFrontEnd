...
const EditarCategoria = (props) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire("Listo!", "Se ha editado la categoria", "success");
    } catch (error) {
      Swal.fire({
        icon: "error",
        title: "Oops...",
  ...
  return (
    <Layout>
      <div className="customContainer rounded lovaYaFont">
        <h1 className="editCategoriaTitle text-center">Editar Categoria</h1>
        {showAlert ? (
